...
- New profiles: 
  ...
  - AU eRequesting Task Base and AU eRequesting Task Group (along with renaming AU eRequesting Task to AU eRequesting Task DiagnosticRequest) [FHIR-49372](https://jira.hl7.org/browse/FHIR-49372)
