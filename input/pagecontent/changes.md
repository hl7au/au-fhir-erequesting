...
- [AU eRequesting CommunicationRequest](StructureDefinition-au-erequesting-communicationrequest.html):
  ...
  - added CommunicationRequest.category value set binding to AU eRequesting CommunicationRequest Category (extensible) and removed reasonCode Must Support and obligations [AU eReq: FHIR-52409](https://jira.hl7.org/browse/FHIR-52409)
