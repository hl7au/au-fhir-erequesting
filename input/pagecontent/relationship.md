...
[International Patient Summary 2.0.0](https://build.fhir.org/ig/HL7/fhir-ips/)|This IG describes how to represent in HL7 FHIR the International Patient Summary (IPS). An International Patient Summary (IPS) document is an electronic health record extract containing essential healthcare information about a subject of care. AU eRequesting supports selected IPS profiles.
{:.grid}
