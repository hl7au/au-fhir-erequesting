...
<tbody>
  <tr>
    ...
    <td>Service request<br>Medical imaging request<br>Implanted medical device summary<br>Adverse reaction risk summary<br>Problem/Diagnosis summary<br>Sex and gender summary<br></td>
  </tr>
  <tr>
    <td>D02</td>
    ...
    <td><a href="ActorDefinition-au-erequesting-actor-placer.html">AU eRequesting Placer actor</a><br><a href="ActorDefinition-au-erequesting-actor-filler.html">AU eRequesting Filler actor</a></td>
  <td>Service request<br>Medical imaging request<br>Implanted medical device summary<br>Adverse reaction risk summary<br>Problem/Diagnosis summary<br>Sex and gender summary<br></td>
  </tr>
  <tr>
    <td>D03</td>
    ...
    <td><a href="ActorDefinition-au-erequesting-actor-placer.html">AU eRequesting Placer actor</a><br><a href="ActorDefinition-au-erequesting-actor-filler.html">AU eRequesting Filler actor</a><br><a href="ActorDefinition-au-erequesting-actor-patientaccess.html">AU eRequesting Patient Access actor</a></td>
  <td>Service request<br>Medical imaging request<br>Implanted medical device summary<br>Adverse reaction risk summary<br>Problem/Diagnosis summary<br>Sex and gender summary<br></td>
  </tr>
  <tr>
    <td>D04</td>
    ...
    <td><a href="ActorDefinition-au-erequesting-actor-placer.html">AU eRequesting Placer actor</a><br><a href="ActorDefinition-au-erequesting-actor-filler.html">AU eRequesting Filler actor</a><br><a href="ActorDefinition-au-erequesting-actor-patientaccess.html">AU eRequesting Patient Access actor</a><br><a href="ActorDefinition-au-erequesting-actor-server.html">AU eRequesting Server actor</a></td>
  <td>Service request<br>Medical imaging request<br>Implanted medical device summary<br>Adverse reaction risk summary<br>Problem/Diagnosis summary<br>Sex and gender summary<br></td>
  </tr>
</tbody>
</table>
...
<tbody>
  ...
  <tr>
    ...
    <td><a href="ActorDefinition-au-erequesting-actor-filler.html">AU eRequesting Filler actor</a><br><a href="ActorDefinition-au-erequesting-actor-server.html">AU eRequesting Server actor</a></td>
   <td>Service request</td>
  </tr>
  <tr>
    <td>G07</td>
