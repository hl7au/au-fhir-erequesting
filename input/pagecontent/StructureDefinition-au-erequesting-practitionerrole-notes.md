...
<table class="list" width="100%">
  <tbody>
    ...
    <tr>
      <td>_include=PractitionerRole:practitioner</td>
      <td><b>SHALL</b></td>
      <td><b>MAY</b></td>
      <td><b>MAY</b></td>
      <td><b>MAY</b></td>
    ...
    <tr>
      <td>_include=PractitionerRole:organization</td>
      <td><b>SHALL</b></td>
      <td><b>MAY</b></td>
      <td><b>MAY</b></td>
      <td><b>MAY</b></td>
...
1. **[`_id`](https://hl7.org/fhir/R4/practitionerrole.html#search)** search parameter
   - including support for these **[`_include`](http://hl7.org/fhir/R4/search.html#include)** parameters: `PractitionerRole:practitioner`and `PractitionerRole:organization`

    `GET [base]/PractitionerRole?_id=[id]`

    Example:

      1. GET [base]/PractitionerRole?_id=123456
      1. GET [base]/PractitionerRole?_id=123456&_include=PractitionerRole:practitioner&_include=PractitionerRole:organization
...
1. **[`identifier`](https://hl7.org/fhir/R4/practitionerrole.html#search)** search parameter
   - including support for these **[`_include`](http://hl7.org/fhir/R4/search.html#include)** parameters: `PractitionerRole:practitioner`and `PractitionerRole:organization`
    ...
    Example:
      ...
      1. GET [base]/PractitionerRole?identifier=http://ns.electronichealth.net.au/id/medicare-provider-number\|2426621B&_include=PractitionerRole:practitioner&_include=PractitionerRole:organization
