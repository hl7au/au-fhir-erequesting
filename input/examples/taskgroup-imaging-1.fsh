...
* extension[=].valueString = "Task - Imaging Task Group"
* extension[+].url = "http://hl7.org/fhir/StructureDefinition/resource-instance-description"
* extension[=].valueMarkdown = "Shows an example of a group of tasks that are part of the same fulfilment group for an Imaging Request for the *AU eRequesting Task Group* profile. Patient: Fred Roberts."
