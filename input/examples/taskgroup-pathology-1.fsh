Instance: taskgroup-pathology-1
InstanceOf: Task
Usage: #example
* meta.profile = "http://hl7.org.au/fhir/ereq/StructureDefinition/au-erequesting-task-group"
* meta.tag = $au-erequesting-task-tag#fulfilment-task-group
* extension[0].url = "http://hl7.org/fhir/StructureDefinition/resource-instance-name"
* extension[=].valueString = "Task - Pathology Task Group"
* extension[+].url = "http://hl7.org/fhir/StructureDefinition/resource-instance-description"
* extension[=].valueMarkdown = "Shows an example of a group of tasks that are part of the same fulfilment group for a Pathology Request for the *AU eRequesting Task Group* profile. Patient: Fred Roberts."
