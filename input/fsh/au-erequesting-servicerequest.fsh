...
* authoredOn ^extension[http://hl7.org/fhir/StructureDefinition/obligation][0].extension[actor].valueCanonical =  "http://hl7.org.au/fhir/core/ActorDefinition/au-erequesting-actor-placer"
...
* authoredOn ^extension[http://hl7.org/fhir/StructureDefinition/obligation][2].extension[code].valueCode = #SHALL:no-error
* authoredOn ^extension[http://hl7.org/fhir/StructureDefinition/obligation][2].extension[actor][0].valueCanonical =  "http://hl7.org.au/fhir/core/ActorDefinition/au-erequesting-actor-filler"
* authoredOn ^extension[http://hl7.org/fhir/StructureDefinition/obligation][2].extension[actor][1].valueCanonical =  "http://hl7.org.au/fhir/core/ActorDefinition/au-erequesting-actor-patient"
