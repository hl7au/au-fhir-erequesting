...
Description: "Category codes for a communication request used in the Australian eRequesting context."
...
* ^status = #active 
* ^experimental = false
* include codes from system http://terminology.hl7.org.au/CodeSystem/communicationrequest-category
