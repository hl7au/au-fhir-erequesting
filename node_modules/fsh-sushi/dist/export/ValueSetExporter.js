...
class ValueSetExporter {
    ...
    setCaretRules(valueSet, rules) {
        ...
        const rulesWithInstances = rules
            ...
            try {
                const { pathParts } = valueSetSD.validateValueAtPath(rule.caretPath, rule.value, this.fisher);
                ...
                if (originalErr instanceof errors_1.MismatchedTypeError &&
                    ...
                    const instanceExporter = new _1.InstanceExporter(this.tank, this.pkg, this.fisher);
                    const { instance, pathParts } = (0, common_1.validateInstanceFromRawValue)(valueSet, rule, instanceExporter, this.fisher, originalErr);
                    rule.value = instance;
                    ruleMap.set((0, utils_1.assembleFSHPath)(pathParts).replace(/\[0+\]/g, ''), { pathParts });
                    return rule;
                }
        ...
        (0, common_1.setImpliedPropertiesOnInstance)(valueSet, valueSetSD, [...ruleMap.keys()], [], this.fisher, knownSlices);
